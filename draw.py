...
plt.figure()
plt.title('influent')
plt.plot(t2, mixed_in, label='influent')
plt.show()
plt.figure()
plt.title('middle layer')
plt.plot(t2, mixed_second, label='2L')
plt.plot(t2, mixed_third, label='3L')
plt.plot(t2, mixed_forth, label='4L')
plt.legend(loc='upper right')
plt.show()
plt.figure()
plt.title('effluent')
plt.plot(t2, mixed_effluent, label='effluent')
plt.show()
